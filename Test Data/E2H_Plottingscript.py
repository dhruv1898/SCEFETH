...
def plot_results_avgdelay(enddevice_id, e2h_avgdelay_e1, e2h_avgdelay_e2, e2h_avgdelay_e3, e2h_avgdelay_e4,
    ...
    plt.bar_label(e1_e2h_delay, padding=3, rotation = 90, fontsize=26)
    plt.bar_label(e2_e2h_delay, padding=3, rotation = 90, fontsize=26)
    plt.bar_label(e3_e2h_delay, padding=3, rotation = 90, fontsize=26)
    plt.bar_label(e4_e2h_delay, padding=3, rotation = 90, fontsize=26)
    ...
    plt.legend(fontsize=24,bbox_to_anchor=(0.68,1))
    plt.tight_layout()
    plt.show()
    plt.close()
    ...
    plt.bar_label(e1_e2g_delay, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(e2_e2g_delay, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(e3_e2g_delay, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(e4_e2g_delay, padding=3, rotation = 90, fontsize=22)
    plt.ylabel('Delay (in sec.)', fontsize=26)
    ...
    plt.bar_label(e1_g2h_delay, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(e2_g2h_delay, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(e3_g2h_delay, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(e4_g2h_delay, padding=3, rotation = 90, fontsize=22)
    plt.ylabel('Delay (in sec.)', fontsize=26)
    ...
    plt.ylim(0,1)
    plt.yticks(fontsize=26)
    plt.legend(fontsize=26, bbox_to_anchor=(0.2,0.45))
    plt.grid()
    plt.tight_layout()
    plt.show()
    plt.close()
    ...
    plt.bar_label(h2e_e1_delratio, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(h2e_e2_delratio, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(h2e_e3_delratio, padding=3, rotation = 90, fontsize=22)
    plt.bar_label(h2e_e4_delratio, padding=3, rotation = 90, fontsize=22)
