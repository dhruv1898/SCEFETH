...
def plot_results_avgdelay(enddevice_id, e2h_avgdelay_e1, e2h_avgdelay_e2, e2h_avgdelay_e3, e2h_avgdelay_e4,
    ...
    labels = ['Gateway 3', 'Gateway 4', 'Gateway 6', 'Gateway 7', 'Gateway 8']
    ...
    plt.bar_label(e1_e2h_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e2_e2h_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e3_e2h_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e4_e2h_delay, padding=3, rotation = 0, fontsize=10)
    plt.ylabel('Delay (in sec.)', fontsize=16)
    plt.title('E2H average delay for all the End-devices', fontsize=16)
    ...
    plt.bar_label(e1_e2g_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e2_e2g_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e3_e2g_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e4_e2g_delay, padding=3, rotation = 0, fontsize=10)
    plt.ylabel('Delay (in sec.)', fontsize=16)
    plt.title('E2G average delay for all the End-devices', fontsize=16)
    plt.xticks(x, labels, fontsize=16)
    plt.yticks(fontsize=16)
    plt.legend(fontsize=16)
    plt.tight_layout()
    ...
    plt.bar_label(e1_g2h_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e2_g2h_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e3_g2h_delay, padding=3, rotation = 0, fontsize=10)
    plt.bar_label(e4_g2h_delay, padding=3, rotation = 0, fontsize=10)
    plt.ylabel('Delay (in sec.)', fontsize=16)
    plt.title('G2H average delay for all the End-devices', fontsize=16)
    plt.xticks(x, labels, fontsize=16)
    plt.yticks(fontsize=16)
    plt.legend(fontsize=16)
    plt.tight_layout()
    ...
    plt.plot(x,e1_e2g_delratio, 'o--', label=enddevice_id[0])
    plt.plot(x,e2_e2g_delratio, 'v--', label=enddevice_id[1])
    plt.plot(x,e3_e2g_delratio, '^--', label=enddevice_id[2])
    plt.plot(x,e4_e2g_delratio, '*--', label=enddevice_id[3])
    plt.title('Delivery Ratio for E2G communication for all the End-devices and Gateways', fontsize=16)
    plt.xticks(x, labels, fontsize=16)
    plt.ylim(0,1)
    plt.yticks(fontsize=16)
    plt.legend(fontsize=16)
    ...
    plt.plot(x,e1_g2h_delratio, 'o--', label=enddevice_id[0])
    plt.plot(x,e2_g2h_delratio, 'v--', label=enddevice_id[1])
    plt.plot(x,e3_g2h_delratio, '^--', label=enddevice_id[2])
    plt.plot(x,e4_g2h_delratio, '*--', label=enddevice_id[3])
    plt.title('Delivery Ratio for G2H communication for all the End-devices and Gateways', fontsize=16)
    plt.xticks(x, labels, fontsize=16)
    plt.ylim(0,1.2)
    plt.yticks(fontsize=16)
    plt.legend(fontsize=16)
    ...
    plt.bar_label(h2e_e1_delratio, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(h2e_e2_delratio, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(h2e_e3_delratio, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(h2e_e4_delratio, padding=3, rotation = 0, fontsize=12)
    plt.title('Delivery Ratio for E2H communication for all the End-devices',fontsize=16)
...
def plot_scatter(dfh_e1, dfg_e1g3_e2g, dfg_e1g4_e2g, dfg_e1g6_e2g, dfg_e1g7_e2g, dfg_e1g8_e2g, dfe1_e2h,
    ...
    labels = ['Gateway 3', 'Gateway 4', 'Gateway5', 'Gateway 6', 'Gateway 7', 'Gateway 8']
    y = range(3,3+len(labels))
    fig, axs = plt.subplots(3, sharex=True, gridspec_kw={'hspace': 0})
    axs[0].plot(range(0, len(dfe1_e2h['scatter'])),dfe1_e2h['scatter'], 'p--')
    axs[1].plot(range(0, len(dfg_e1g3_e2g['scatter'])),dfg_e1g3_e2g['scatter'], 'o--')
    axs[1].plot(range(0, len(dfg_e1g4_e2g['scatter'])),dfg_e1g4_e2g['scatter'], 'v--')
    axs[1].plot(range(0, len(dfg_e1g6_e2g['scatter'])),dfg_e1g6_e2g['scatter'], '*--')
    axs[1].plot(range(0, len(dfg_e1g7_e2g['scatter'])),dfg_e1g7_e2g['scatter'], '^--')
    axs[1].plot(range(0, len(dfg_e1g8_e2g['scatter'])),dfg_e1g8_e2g['scatter'], 's--')
    axs[2].plot(range(0, len(dfh_e1['scatter'])),dfh_e1['scatter'], 'x--')
    axs[0].yaxis.set_ticklabels([])
    axs[2].yaxis.set_ticklabels([])
    plt.xlabel("Packet number",fontsize=16)
    axs[0].set_ylabel("ID001",fontsize=16)
    axs[1].set_yticks(y)
    axs[1].set_yticklabels(labels,fontsize=16)
    axs[2].set_ylabel("Habitat",fontsize=16)
    fig.suptitle('Data packets received from ID001 on different Gateways and the Habitat',fontsize=16)
    plt.show()
    plt.close()

    fig, axs = plt.subplots(3, sharex=True, gridspec_kw={'hspace': 0})
    axs[0].plot(range(0, len(dfe2_e2h['scatter'])),dfe2_e2h['scatter'], 'p--')
    axs[1].plot(range(0, len(dfg_e2g3_e2g['scatter'])),dfg_e2g3_e2g['scatter'], 'o--')
    axs[1].plot(range(0, len(dfg_e2g4_e2g['scatter'])),dfg_e2g4_e2g['scatter'], 'v--')
    axs[1].plot(range(0, len(dfg_e2g6_e2g['scatter'])),dfg_e2g6_e2g['scatter'], '*--')
    axs[1].plot(range(0, len(dfg_e2g7_e2g['scatter'])),dfg_e2g7_e2g['scatter'], '^--')
    axs[1].plot(range(0, len(dfg_e2g8_e2g['scatter'])),dfg_e2g8_e2g['scatter'], 's--')
    axs[2].plot(range(0, len(dfh_e2['scatter'])),dfh_e2['scatter'], 'x--')
    axs[0].yaxis.set_ticklabels([])
    axs[2].yaxis.set_ticklabels([])
    plt.xlabel("Packet number",fontsize=16)
    axs[0].set_ylabel("ID002",fontsize=16)
    axs[1].set_yticks(y)
    axs[1].set_yticklabels(labels,fontsize=16)
    axs[2].set_ylabel("Habitat",fontsize=16)
    fig.suptitle('Data packets received from ID002 on different Gateways and the Habitat',fontsize=16)
    plt.show()
    plt.close()

    fig, axs = plt.subplots(3, sharex=True, gridspec_kw={'hspace': 0})
    axs[0].plot(range(0, len(dfe3_e2h['scatter'])),dfe3_e2h['scatter'], 'p--')
    axs[1].plot(range(0, len(dfg_e3g3_e2g['scatter'])),dfg_e3g3_e2g['scatter'], 'o--')
    axs[1].plot(range(0, len(dfg_e3g4_e2g['scatter'])),dfg_e3g4_e2g['scatter'], 'v--')
    axs[1].plot(range(0, len(dfg_e3g6_e2g['scatter'])),dfg_e3g6_e2g['scatter'], '*--')
    axs[1].plot(range(0, len(dfg_e3g7_e2g['scatter'])),dfg_e3g7_e2g['scatter'], '^--')
    axs[1].plot(range(0, len(dfg_e3g8_e2g['scatter'])),dfg_e3g8_e2g['scatter'], 's--')
    axs[2].plot(range(0, len(dfh_e3['scatter'])),dfh_e3['scatter'], 'x--')
    axs[0].yaxis.set_ticklabels([])
    axs[2].yaxis.set_ticklabels([])
    plt.xlabel("Packet number",fontsize=16)
    axs[0].set_ylabel("ID003",fontsize=16)
    axs[1].set_yticks(y)
    axs[1].set_yticklabels(labels,fontsize=16)
    axs[2].set_ylabel("Habitat",fontsize=16)
    fig.suptitle('Data packets received from ID003 on different Gateways and the Habitat',fontsize=16)
    plt.show()
    plt.close()

    fig, axs = plt.subplots(3, sharex=True, gridspec_kw={'hspace': 0})
    axs[0].plot(range(0, len(dfe4_e2h['scatter'])),dfe4_e2h['scatter'], 'p--')
    axs[1].plot(range(0, len(dfg_e4g3_e2g['scatter'])),dfg_e4g3_e2g['scatter'], 'o--')
    axs[1].plot(range(0, len(dfg_e4g4_e2g['scatter'])),dfg_e4g4_e2g['scatter'], 'v--')
    axs[1].plot(range(0, len(dfg_e4g6_e2g['scatter'])),dfg_e4g6_e2g['scatter'], '*--')
    axs[1].plot(range(0, len(dfg_e4g7_e2g['scatter'])),dfg_e4g7_e2g['scatter'], '^--')
    axs[1].plot(range(0, len(dfg_e4g8_e2g['scatter'])),dfg_e4g8_e2g['scatter'], 's--')
    axs[2].plot(range(0, len(dfh_e4['scatter'])),dfh_e4['scatter'], 'x--')
    axs[0].yaxis.set_ticklabels([])
    axs[2].yaxis.set_ticklabels([])
    plt.xlabel("Packet number",fontsize=16)
    axs[0].set_ylabel("ID004",fontsize=16)
    axs[1].set_yticks(y)
    axs[1].set_yticklabels(labels,fontsize=16)
    axs[2].set_ylabel("Habitat",fontsize=16)
    fig.suptitle('Data packets received from ID004 on different Gateways and the Habitat',fontsize=16)
    plt.show()
    plt.close()
