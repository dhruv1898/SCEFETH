...
def plot_delay_and_delratio(h2e_delay,h2g_delay,g2e_delay,h2e_delratio,Enddevices,Gateways):
    ...
    plt.bar_label(e1_h2g_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e2_h2g_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e3_h2g_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e4_h2g_delay, padding=3, rotation = 0, fontsize=12)
    plt.xticks(fontsize=16)
    plt.yticks(fontsize=16)
    plt.ylabel('Delay (in sec.)', fontsize=16)
    plt.title('H2G average delay for all the End-devices', fontsize=16)
    plt.legend()
    plt.show()
    plt.close()
    ...
    plt.bar_label(e1_g2e_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e2_g2e_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e3_g2e_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e4_g2e_delay, padding=3, rotation = 0, fontsize=12)
    plt.ylabel('Delay (in sec.)', fontsize=16)
    plt.title('G2E average delay for all the End-devices', fontsize=16)
    plt.legend()
    plt.xticks(fontsize=16)
    plt.yticks(fontsize=16)
    plt.show()
    ...
    plt.bar_label(e1_h2e_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e2_h2e_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e3_h2e_delay, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e4_h2e_delay, padding=3, rotation = 0, fontsize=12)
    plt.ylabel('Delay (in sec.)', fontsize=16)
    plt.title('H2E average delay for all the End-devices', fontsize=16)
    plt.legend()
    plt.xticks(fontsize=16)
    plt.yticks(fontsize=16)
    plt.show()
    ...
    plt.bar_label(e1_h2e_delratio, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e2_h2e_delratio, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e3_h2e_delratio, padding=3, rotation = 0, fontsize=12)
    plt.bar_label(e4_h2e_delratio, padding=3, rotation = 0, fontsize=12)
    plt.title('Delivery Ratio for each end-device in H2E communication', fontsize=16)
    plt.legend()
    plt.xticks(fontsize=16)
    plt.yticks(fontsize=16)
    plt.show()
...
def plot_packets(dfh_e1_g5, dfg5_e1_h2g, dfe1_g2e, dfh_e2_g6, dfg6_e2_h2g, dfe2_g2e, dfh_e3_g8, dfg8_e3_h2g, dfe3_g2e, dfh_e4_g3, dfg3_e4_h2g, dfe4_g2e):
    ...
    axs[0].plot(range(0, len(dfh_e1_g5['scatter'])),dfh_e1_g5['scatter'], '^--',color='blue')
    axs[0].plot(range(0, len(dfg5_e1_h2g['scatter'])),dfg5_e1_h2g['scatter'], 'o--',color='blue')
    axs[0].plot(range(0, len(dfe1_g2e['scatter'])),dfe1_g2e['scatter'], 'x--',color='blue', label='ID001')
    axs[0].legend(loc='best', fontsize=16)

    axs[1].plot(range(0, len(dfh_e2_g6['scatter'])),dfh_e2_g6['scatter'], '^--',color='green')
    axs[1].plot(range(0, len(dfg6_e2_h2g['scatter'])),dfg6_e2_h2g['scatter'], 'o--',color='green')
    axs[1].plot(range(0, len(dfe2_g2e['scatter'])),dfe2_g2e['scatter'], 'x--',color='green', label='ID002')
    axs[1].legend(loc='best', fontsize=16)

    axs[2].plot(range(0, len(dfh_e3_g8['scatter'])),dfh_e3_g8['scatter'], '^--',color='orange')
    axs[2].plot(range(0, len(dfg8_e3_h2g['scatter'])),dfg8_e3_h2g['scatter'], 'o--',color='orange')
    axs[2].plot(range(0, len(dfe3_g2e['scatter'])),dfe3_g2e['scatter'], 'x--',color='orange', label='ID003')
    axs[2].legend(loc='best', fontsize=16)

    axs[3].plot(range(0, len(dfh_e4_g3['scatter'])),dfh_e4_g3['scatter'], '^--',color='cyan')
    axs[3].plot(range(0, len(dfg3_e4_h2g['scatter'])),dfg3_e4_h2g['scatter'], 'o--',color='cyan')
    axs[3].plot(range(0, len(dfe4_g2e['scatter'])),dfe4_g2e['scatter'], 'x--',color='cyan', label='ID004')
    axs[3].legend(loc='best', fontsize=16)
    
    fig.suptitle('Data packets received from the Habitat on different Gateway and the Enddevice',fontsize=16)
...
Gateways = ["Gateway 5", "Gateway 6", "Gateway 8", "Gateway 3"]
