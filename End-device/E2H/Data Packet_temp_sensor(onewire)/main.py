...
def time_sync(s):
    ...
    sync_req = 'N:ID001:'+str(time.time())
    print(sync_req)
...
def data_send(file, temp):
    ...
    if i == 30:
        ...
        taapman = temp.read_temp_async()/100
        temp.start_conversion()
        data_send = 'D:ID001: Moin! Temperature value =  ' + str(taapman) + ':' + str(c) # packet format
